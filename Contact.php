...
<head>
    ...
    <link rel="stylesheet" href="./Asset/Other.css">
    <link rel="stylesheet" href="./Asset/Grid.css">
    <title>GruhShobha</title>
</head>
...
<body>
    <header class="sticky-top">
        <div class="header-section">
            <div class="container">
                <div class="menu" id="headDiv1">
                    <div class="mainlogo">
                        <a href="./index.html">
                            <img src="././Asset/Images/Logo-Gruhashobha-SVG 1.png" alt="">
                        </a>
                    </div>
                    <div class="menu-list">
                        <ul class="drop-menu">
                            ...
                            <li>
                                <div class="dropdown  nav-dropdown">
                                    <div class="drop1">
                                        <a href="./Projectgrid.html"> Projects</a>
                                    </div>
                                    <!--<ul class="dropdown-menu">-->

                                    <!--    <li><a href="./Projectgrid.html">Project Grid</a></li>-->
                                    <!--    <li><a href="./Projectsignal.html">Project Signal</a> </li>-->
                                    <!--    </ul>-->
                                </div>
                    ...
                    <div class="MobileNewMenuList">
                        ...
                        <div class="accordion" id="accordionExample">
                            ...
                            <div class="accordion-item acord-item1">
                                <h2 class="accordion-header">
                                    <button class="accordion-button collapsed acord-btn" type="button"
                        ...
                        <div class="MobileMenuBar1 new-menubar">
                            <span class="material-symbols-outlined cross removeToggler">
                                <i class="fa-solid fa-xmark"></i>
                            </span>
                        </div>
                    </div>
                    <div class="MobileMenuBar  addToggler">
    ...
    <section class="Aboutpage-sec">
        <div class="about-sec-banner contact-bg">
            <div class="container left-right-padding ">
                <div class="banner-heading">
                    <h2 class="banner-head">
                        Contact</h2>
                    <p class="subhead"> <a href="./index.html">Home</a> &nbsp;- <span>
                            Contact</span></p>
                </div>
            </div>
        </div>
    </section>
    <div class="contact-sec-page">
        <div class="container left-right-padding">
            <div class="row gx-5">
                <div class="col-lg-6">
                    <div class="SecTwrapper ">
                        <div class="Secctitle contact-heading">Want to Work with Us?</div>
                    ...
                    <div class="maping-section">
                        <div class="addres-div">
                            ...
                            <div class="address">
                                ...
                                <p class="add-cnt">
                                    Aashirvad Bldg .101,<br />
                                    Near Maruti Nanavre Bridge,,<br /> Service Road Highway, Baner,Pune-45
                        ...
                        <div class="addres-div">
                            ...
                            <div class="address">
                                ...
                                <p class="add-cnt">
                                    <strong>Email:</strong>
                                    gruhashobhainteriors@gmail.com<br />
            ...
            <div class="map-section">
                <iframe class="w-100"
                    src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3782.4994634723557!2d73.7699975!3d18.5515079!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3bc2bec9f49c83cb%3A0xe89f53a8c77f11f0!2sGruhashobha%20Interiors!5e0!3m2!1sen!2sin!4v1707829033128!5m2!1sen!2sin"
